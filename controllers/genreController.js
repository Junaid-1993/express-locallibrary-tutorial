...
// We do not need asyncHandler function here as we are expecting no exception will be thrown here.
...
exports.genre_create_post = [
  ...
  asyncHandler(async (req, res, next) => {
    ...
    // IsEmpty():true means there are no errors, IsEmpty():false means there are errors
    if (!errors.isEmpty()) {
      ...
      // To ignore letter case and accents when searching we chain the collation() method.
